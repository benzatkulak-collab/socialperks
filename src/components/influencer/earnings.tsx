      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            ...
            className="w-fit rounded-lg bg-brand-green px-5 py-2 text-sm font-semibold text-brand-bg transition-opacity hover:opacity-90"
          ...
          <div className="mt-4 rounded-xl border border-brand-green/30 bg-brand-green/5 p-4">
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                className="rounded-lg bg-brand-green px-4 py-1.5 text-sm font-semibold text-brand-bg transition-opacity hover:opacity-90"
              >
                Confirm Withdrawal
              </button>
              <button
                ...
                className="rounded-lg border border-brand-border bg-brand-elevated px-4 py-1.5 text-sm font-medium text-brand-text transition-colors hover:border-brand-subtle"
              >
                Cancel
              </button>
            </div>
