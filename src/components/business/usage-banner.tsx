...
function nextPlan(currentPlan: string): { key: string; label: string; price: string } {
  ...
  if (currentPlan === "starter") return { key: "professional", label: "Pro", price: "$79/mo" };
  // Pro hitting limits → Enterprise (multi-location). Same for any unknown plan.
  return { key: "enterprise", label: "Enterprise", price: "$149/mo" };
}
