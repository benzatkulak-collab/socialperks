...
export async function GET(): Promise<Response> {
  ...
  const context = {
    ...
    keyFacts: {
      ...
      pricingModelSummary:
        "Free tier: 1 active campaign, 50 completions/month. Starter $29/mo ($290/yr): 10 campaigns, 500 completions. Pro $79/mo ($790/yr): 50 campaigns, 5000 completions. Enterprise $149/mo ($1490/yr): multi-location, unlimited campaigns. Annual billing saves 2 months on every paid plan.",
      ftcCompliance:
    ...
    agentSurfaces: {
      mcp: {
        ...
        tools: [
          ...
          "searchInfluencers",
          "listCampaigns (auth)",
          "listSubmissions (auth)",
          "getCampaignStats (auth)",
          "createCampaign (auth, write)",
          "submitProof (auth, write)",
          "reviewSubmission (auth, write)",
        ],
      },
    ...
    sampleQueries: [
      ...
      },
      {
        ...
        answer:
          "Free tier with limits, $29/mo Starter, $79/mo Pro, $149/mo Enterprise. Annual saves 2 months. See /pricing.",
      },
      {
