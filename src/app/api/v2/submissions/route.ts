/**
 * GET  /api/v2/submissions — List submissions (v2 format)
 * POST /api/v2/submissions — Create submission (v2 format)
 *
 * Thin wrapper: transforms v2 requests to v1 internally,
 * delegates to existing submission logic, transforms response back to v2.
 */
