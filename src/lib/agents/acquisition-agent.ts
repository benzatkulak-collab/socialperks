...
— The Social Perks team`;
  // Escape user-supplied fields before embedding in HTML (business name and
  // city come from the waitlist sign-up form and may contain HTML metacharacters).
  const safeName = escapeHtml(name);
  const htmlCityClause = lead.city
