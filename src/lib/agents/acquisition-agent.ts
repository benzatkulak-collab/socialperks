...
— The Social Perks team`;
  // Escape user-supplied fields before interpolating into HTML — businessName
  // and city come from waitlist signups and must not reach the email body raw.
  const safeName = escapeHtml(name);
  const safeCityClause = lead.city
