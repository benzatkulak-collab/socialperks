...
export const ANSWERS: AnswerPage[] = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "Free low-cost items tend to feel more valuable than an equivalent percentage discount — higher perceived value, similar cost to you",
    ],
    category: "tactics",
    lastReviewed: "2026-05-15",
    related: {
  ...
  // ─── Platform-specific ─────────────────────────────────────────────
  {
    ...
    keyPoints: [
      ...
      "Approve each submission in one click before the perk is issued",
    ],
    category: "tactics",
    lastReviewed: "2026-05-15",
    related: {
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "Customer marketing tends to be more cost-efficient than paid influencers for ongoing, local reach",
    ],
    category: "comparison",
    lastReviewed: "2026-05-15",
    related: {
  ...
  // ─── Tactics expansion ─────────────────────────────────────────────
  {
    ...
    keyPoints: [
      ...
      "An in-person ask converts far better than signage the customer has to notice and act on alone",
    ],
    category: "tactics",
    lastReviewed: "2026-05-15",
    related: {
  ...
  },
  {
    ...
    ctas: [
      {
        label: "Try a customer-marketing campaign free →",
        href: "/dashboard#signup",
      },
    ],
  },
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "Reward posts with a free appetizer — a few dollars of food cost for a post to their local network",
      "Repost customer photos with credit — signals you care",
      "Post volume scales with your foot traffic and how consistently staff ask — the effect compounds over time",
    ],
    category: "tactics",
    lastReviewed: "2026-05-15",
    related: {
