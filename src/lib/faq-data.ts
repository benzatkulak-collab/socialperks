...
export const FAQ_ENTRIES: FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "There's a free tier with one active campaign, 50 customer completions per month, and basic features. Paid plans are $29/month (Starter), $79/month (Pro), and $149/month (Enterprise), with annual billing offering 2 months free. Custom multi-location plans are available on request. The cost of the perks themselves (the discounts and free items) is set by you — Social Perks doesn't take a cut of the customer reward.",
  },
  {
    slug: "what-is-a-perk",
    category: "getting-started",
  ...
  // ─── Additional pricing ──────────────────────────────────────────────
  {
    ...
    answer:
      "Stripe processing fees are included in the listed plan prices ($29 Starter, $79 Pro, $149 Enterprise). What you see is what you pay. The cost of perks themselves is separate — those are paid by you to your customers via discount/free-item delivery; Social Perks doesn't take a cut of customer rewards.",
  },
  {
